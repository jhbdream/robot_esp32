...
void mqtt_task(void *pvParameters)
{
    ...
    printf("mqtt_task client->settings->port connect port %d\n", client->settings->port);
    printf("mqtt_task client->settings->host host %s\n", client->settings->host);
    ...
    while (1) {
        ...
        mqtt_info("mqtt_start_receive_schedule finished");
...
mqtt_client *mqtt_start(mqtt_settings *settings)
{
    ...
    printf("mqtt_start connect port %d\n", settings->port);
    ...
    printf("mqtt_startclient->settings->port connect port %d\n", client->settings->port);
